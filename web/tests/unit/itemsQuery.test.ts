...
it("parses drill params", () => {
  expect(parseItemFilters({ category: "PART", dummy: "true", target_dos: "missing", page: "2" }))
    .toEqual({ category: "PART", dummy: true, target_dos: "missing", page: 2, q: undefined, sort: undefined, abc: undefined, xyz: undefined, pattern: undefined, champion: undefined });
});
