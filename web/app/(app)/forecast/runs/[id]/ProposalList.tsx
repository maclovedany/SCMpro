...
type Resp = { diagnosis?: { area: string; finding: string; evidence: string }[]; proposals?: { method_key: string; param_patch: Record<string, unknown>; enabled: boolean | null; scope: string; rationale: string; expected_effect: string }[]; data_issues?: string[] };
