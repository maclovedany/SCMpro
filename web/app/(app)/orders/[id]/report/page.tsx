...
export default async function ReportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const names = await fetchItemNames(sb, top.map(l => l.key_code));   // R-UI-15: 코드 옆 품명
  return (
